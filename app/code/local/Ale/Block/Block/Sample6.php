...
//app/code/local/Ale/Block/Block/Sample6.php

class Ale_Block_Block_Sample6 extends Mage_Core_Block_Template
{
    public function _construct()
    {
        $this->setTemplate('ale_block/sampletemplate6.phtml');
