...
//app/code/local/Ale/Block/Block/Sample5.php

class Ale_Block_Block_Sample5 extends Mage_Core_Block_Template
{
    public function _construct()
    {
        $this->setTemplate('ale_block/sampletemplate5.phtml');
