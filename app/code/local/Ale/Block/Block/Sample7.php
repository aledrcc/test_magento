...
//app/code/local/Ale/Block/Block/Sample7.php

class Ale_Block_Block_Sample7 extends Mage_Core_Block_Template
{
    public function _construct()
    {
        $this->setTemplate('ale_block/sampletemplate7.phtml');
